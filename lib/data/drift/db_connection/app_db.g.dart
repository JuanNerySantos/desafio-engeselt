...
class $StoreDataTable extends StoreData
  ...
  static const VerificationMeta _latlongMeta = const VerificationMeta(
    'latlong',
  );
  @override
  ...
  static const VerificationMeta _selectedStateMeta = const VerificationMeta(
    'selectedState',
  );
  @override
  ...
  StoreDataData map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return StoreDataData(
      ...
      selectedState:
          attachedDatabase.typeMapping.read(
            DriftSqlType.string,
            data['${effectivePrefix}selected_state'],
          )!,
    );
  }
...
class $ProductTable extends Product with TableInfo<$ProductTable, ProductData> {
  ...
  static const VerificationMeta _nameProductMeta = const VerificationMeta(
    'nameProduct',
  );
  @override
  ...
  ProductData map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return ProductData(
      ...
      nameProduct:
          attachedDatabase.typeMapping.read(
            DriftSqlType.string,
            data['${effectivePrefix}name_product'],
          )!,
      price:
          attachedDatabase.typeMapping.read(
            DriftSqlType.string,
      ...
      image: $ProductTable.$converterimage.fromSql(
        attachedDatabase.typeMapping.read(
          DriftSqlType.string,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    map['store_id'] = Variable<String>(storeId);
    {
      map['image'] = Variable<String>(
        $ProductTable.$converterimage.toSql(image),
      );
    }
...
class ProductCompanion extends UpdateCompanion<ProductData> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (image.present) {
      map['image'] = Variable<String>(
        $ProductTable.$converterimage.toSql(image.value),
      );
    }
